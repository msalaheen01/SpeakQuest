...
export default function PastAttempts({ attemptHistory = [] }) {
  ...
  return (
    <div className={styles.pastAttemptsContainer}>
      <button 
      ...
      >
        ...
        <span className={styles.toggleLabel}>Past Attempts</span>
      ...
      {isExpanded && (
        <div className={styles.content}>
          ...
          <div className={styles.summarySection}>
            ...
            {avgSimilarity !== null && (
              <div className={styles.summaryItem}>
                <div className={styles.summaryLabel}>Avg Similarity</div>
          ...
          <div className={styles.attemptsList}>
            <div className={styles.attemptsHeader}>Recent Attempts</div>
            {recentAttempts.map((attempt, index) => (
              <div key={index} className={styles.attemptItem}>
                <div className={styles.attemptHeader}>
                  ...
                  <span className={styles.attemptTime}>{formatTimeAgo(attempt.timestamp)}</span>
                </div>
